...
class User extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('email, password, group', 'required'),
            ...
            array('id, first_name, last_name, email, password, group, active, created_date, updated_date, facebook_id, twitter_id', 'safe', 'on' => 'search'),
        );
    }
